...
for listener in listeners:
    print('\n')
    shortest_path_to_listener, total_weight_to_listener = dfs(network, start_node, listener)
    if shortest_path_to_listener:
        print(f"Shortest path to {listener}:", shortest_path_to_listener)
        print(f"Total weight to {listener}:", total_weight_to_listener)
    else:
